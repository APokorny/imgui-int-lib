...
if("${EMSCRIPTEN}x" STREQUAL "x")
    ...
    message(ERROR " EMSDK variable points to the emscripten SDK directory")
    message(ERROR " The SDK directory should contain a system directory with all")
    message(ERROR " prebuilt libraries.")
endif()
set(EMSCRIPTEN_SYSTEM ${EMSCRIPTEN}/upstream/emscripten/system)
...
set(CMAKE_EXE_LINKER_FLAGS_INIT "-s WASM=1 -s PTHREAD_POOL_SIZE=2 -s USE_PTHREADS=1 -s USE_WEBGL2=1 -s OFFSCREENCANVAS_SUPPORT=1 -s ASSERTIONS=1 -s GL_ASSERTIONS=1")
...
set(CMAKE_MODULE_LINKER_FLAGS_INIT "-s WASM=1 -s EXPORTED_RUNTIME_METHODS=\"['ccall', 'cwrap']\" -s ASSERTIONS=1 --no_entry")
set(CMAKE_SHARED_MODULE_SUFFIX_CXX .js)
set(CMAKE_SHARED_MODULE_SUFFIX_C .js)
set(CMAKE_MODULE_LINKER_FLAGS_RELEASE_INIT "-O3 --llvm-lto 1")

set(CMAKE_SHARED_LINKER_FLAGS_INIT "-s WASM=1 -s MODULARIZE=1 -s EXPORTED_RUNTIME_METHODS=\"['ccall', 'cwrap']\" -s ASSERTIONS=1 --no_entry")
set(CMAKE_SHARED_LIBRARY_SUFFIX_CXX .js)
set(CMAKE_SHARED_LIBRARY_SUFFIX_C .js)
...
set(CMAKE_DL_LIBS)
set(TOOLCHAIN_FILE_BASE_PATH ${CMAKE_CURRENT_LIST_DIR})
